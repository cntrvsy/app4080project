<script lang="ts">
  ...
  let pfp:string = "https://avatars.githubusercontent.com/u/106774625?v=4"
  </script>
  
  
  <section class="text-gray-400 bg-gray-800 rounded-lg">
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            ...
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <p class="leading-relaxed text-lg mb-4">
                  Hello, my name is Ken Kimiri. a Full Stack Developer based in Nairobi Kenya. 
                  I like to play Football and the Guitar during my free time. 
                  Mainly uses the MERN Stack.  
              </p>
              <!-- github link -->
              <a class=" btn variant-filled-primary" href="https://github.com/Thyshark">
                  My GitHub
              </a>
            </div>
          </div>
              ...
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    intermediate level using system design tool like eraser. 
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 lg:w-1/2 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    Interned as IT support at Royal Media Services. 
                  </p>
                </div>
              </div>
            </div>
             ...
             <div class="p-4 lg:w-1/2 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    you can reach on phone (0704234870) or on email (mr.ken.kimiri@gmail.com) between the hour of 8am till 5pm. 
                  </p>
                </div>
              </div>
            </div>
