<script lang="ts">
  ...
  let pfp:string = "https://avatars.githubusercontent.com/u/85725132?s=96&v=4"
  </script>
          ...
          <div class="flex flex-col sm:flex-row mt-10">
            ...
            <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
              <p class="leading-relaxed text-lg mb-4">
                  Hello, my name is Kyle Sting.  A Front End Developer based in Nairobi, Kenya. my hobbies are reading novels and participating in charity events. I am an expert at using design tools such as Figma.
                  Currently use Phoenix and Go.    
              </p>
              <!-- github link -->
              ...
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    Quick thinking, understranding of design tokens. 
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 lg:w-1/2 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    Freelanced for 2 years as a website designer. 
                  </p>
                </div>
              </div>
            </div>
             ...
             <div class="p-4 lg:w-1/2 md:w-full">
              <div class="flex border-2 rounded-lg border-gray-400 p-8 sm:flex-row flex-col">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">
                    you can reach on phone (0724567125) or on email (kyle-304@github.com) between the hour of 8am till 5pm. 
                  </p>
                </div>
              </div>
            </div>
