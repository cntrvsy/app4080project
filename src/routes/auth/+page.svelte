            ...
            <section>
              <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                ...
                <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                  <h1 class="title-font text-5xl italic gradient-heading">Welcome back to the Design Tokens Revolution!</h1>
                  <p class="leading-relaxed text-lg mt-4">Your journey with us was just the beginning. To continue enjoying the boundless benefits of our design token platform, we invite you to sign in once again.</p>
                  <br/>
