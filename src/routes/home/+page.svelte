<script lang="ts">
  ...
  function toggleComponent_State(state:string) {
    ...
    //arranging the data.
        //getting the cntrvsy data
        let user_id1 = cntrvsy_UUID;
        let id1;
        let name1:string;
                ...
                {:else}
                    ...
                    out:fade={{duration:400}}>
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            {#each db_projects_cntrvsy as {id, ...item}}
